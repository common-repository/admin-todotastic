<?php
namespace Brickdots\AdminTodotastic\base;

use Richdho\Utils\Core as UtilsCore;
...
abstract class Core {
    ...
    protected function __construct() {
        ...
        define('BDOTSTD_TD', $this->getPluginData('TextDomain'));
        define('BDOTSTD_VERSION', $this->getPluginData('Version'));
        $this->construct();
    }
}
